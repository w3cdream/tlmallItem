    ...
    utils.extend(ysp.customHelper, {
        ...
        */
        ...
        menuManager: {
            ...
            getMenuUrl: function getMenuUrl(menuName) {
                if (typeof menuName !== 'string') return;
                return this.menuHash[menuName];
            }
        },
        //获取顶层窗口
        getTop: function getTop(win) {
            var cwin = win;
            try {
        ...
        updateHistoryStateByTabId: function updateHistoryStateByTabId(tabId) {
        ...
        onTargetLoad: function onTargetLoad(aWin, doc) {
            ...
            aWin.doOperate = function (rowIndex, isShowDetail, newPage) {
                ...
                aWin.nui.open({
                    ...
                    ondestroy: function ondestroy(action) {
                        if (action == "ok") {
