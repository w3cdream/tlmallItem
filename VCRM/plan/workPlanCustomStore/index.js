(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control38_ZMVudg: function (elem) {
      if (!elem) {
        return;
      ...
      //   load = elem.ownerDocument.defaultView.localStorage.getItem('layerLoading');
    ...
    doAction_uiControl38_89QBRp: function (data, elem) {
      //返回按钮方法，返回工作台页面
      ...
      if ('ascertain' == data.eventType) {
        debugger;var textArea = data.dataCustom.textArea;var tempAreaText = data.dataCustom.tempAreaText;var selectedCount = data.dataCustom.selectedCount;var addTempDayPlanOkBtn = elem.querySelector('#addTempDayPlanOkBtn') || elem.querySelector('#addDayPlanOkBtn');var addTempDayPlanOkBtn = elem.querySelector('#addTempDayPlanOkBtn');var addDayPlanOkBtn = elem.querySelector('#addDayPlanOkBtn');var cwin = elem.ownerDocument.defaultView;if (addTempDayPlanOkBtn) {
    ...
    getTemplate_uiControl38_89QBRp: function () {
