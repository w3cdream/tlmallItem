 ...
  //行为拦截器
  ...
  cwin._yspNativeEventHandler = function(type, stop) {
    ...
    if (topWin) {
      ...
      //   topWin.open("http://pttlcrm.com/pttlCrm/res/page/visitManager/visitLook/visitlook.html", type);
      //   executePlan('visitLookerTest');
      //   return;
      // } else if (type == 'atMyReportTest') {
      //   topWin.open("http://pttlcrm.com/pttlCrm/res/page/customerAtReport/customerAtReport.html", type);
      //   executePlan('atMyReportTest');
      //   return;
      // } else if (type == 'personVisitAchieveTest') {
      //   if (parent.EAPI.isIOS()) {
      //     ysp.appMain.openWindow('http://pttlcrm.com/ptDataShow/commonReports/commonReportsByEncoder?reportPid=customerView&filter_userId=SONGFEI&encoder=U09OR0ZFSSswNy8xOTIvMjAxNyAxMzo0NjoxOA==');
      //   } else {
      //     topWin.open('http://pttlcrm.com/ptDataShow/commonReports/commonReportsByEncoder?reportPid=customerView&filter_userId=SONGFEI&encoder=U09OR0ZFSSswNy8xOTIvMjAxNyAxMzo0NjoxOA==', type);
    ...
    //       activeWin.close();
    //     }
    //     topWin.location.href = "http://pttlcrm.com/pttlCrm/res/page/login/login.html";
    //   }
    //   return;
    // }
    var taskPool = getSingletonTask();
